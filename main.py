...
class Configuration(object):
    def __init__(self, full_datafile_path, include_georegions_with_at_least_this_many_cases, logplot, differential_plot):
...
if __name__ == '__main__':
    ...
    for logplot in [True, False]:
        for differential_plot in [True, False]:
            run_plotting(Configuration(full_datafile_path, include_georegions_with_at_least_this_many_cases, logplot, differential_plot))
